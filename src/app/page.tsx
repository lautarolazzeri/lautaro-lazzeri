...
export default function Home() {
  return (
    <div className=''>
      <ParticlesBackground />
      <div className='h-[90vh] flex justify-center flex-col items-start mx-36'>
        <div className='flex justify-between w-full mt-8'>
          ...
          <div>
            <h2 className='text-3xl font-body'>Front-end <br /> Web and Mobile <br /> Developer </h2>
            <p className='w-60 mt-8 text-gray-400'>Monogram is a digital agency from Atlanta, specializing in headless ecommerce, web development, and web apps.</p>
          </div>
        </div>
      </div>
